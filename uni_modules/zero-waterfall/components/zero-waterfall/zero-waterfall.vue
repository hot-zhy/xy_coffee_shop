		...
		<view class="waterfall_left">
			<view class="waterfall_item" v-for="(item,index) in listLeft" :key="index">
				<view class="item_img">
					...
					<zero-lazy-load image="/static/images/c3.jpg" :imgMode='imgMode' @load='considerPush' @error='considerPush'>
					</zero-lazy-load>
				</view>
				<view class="item_info">
					<view class="item_info_title mx-1">{{item.xyCoffeeName}}</view>
					<view class="item_info_note mx-1">{{item.xyCoffeeBrief}}</view>
					<!--  #ifdef  MP-WEIXIN -->
